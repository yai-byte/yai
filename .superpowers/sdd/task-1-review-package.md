# Task 1 review package (snapshot diffs; no git)
...
## Makefile diff
--- .superpowers/sdd/Makefile.pre-task1	2026-07-24 21:55:20.560376751 +0800
+++ Makefile	2026-07-24 21:55:40.390053333 +0800
@@ -10,6 +10,7 @@
 	src/commands.cpp \
...
## core.cpp full diff
--- .superpowers/sdd/core.cpp.pre-task1	2026-07-24 21:55:20.558166852 +0800
+++ src/core.cpp	2026-07-24 21:55:40.575041908 +0800
@@ -10,160 +10,6 @@
...
src/core.cpp:14:std::optional<std::string> env_string(const char* name) {
src/core.cpp:22:std::string ascii_lower(std::string value) {
src/core.cpp:30:std::string home_dir() {
src/core.cpp:247:std::string replace_all(std::string value, const std::string& from, const std::string& to) {
src/i18n.cpp:162:Language current_language() {
src/i18n.cpp:192:bool use_chinese() {
src/i18n.cpp:196:std::string tr(const std::string& msgid) {
src/i18n.cpp:205:std::string tr_format(
