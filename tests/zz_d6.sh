...
# AppImageHub bases default to public hosts. Point them at the local fixtures so
# the crawl never leaves the machine: every page this test exercises is served
# from $TMP_HOME.
